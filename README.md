...
▶ [21s demo](https://aard.win/sdk-demo.mp4) — same login card in a Next.js app and a Vue app, then the OAuth callback round-trip.
...
<table>
  ...
  <tr>
    <td><img src="preview/nextjs-snapshot.png" alt="aardwin login card rendered in a Next.js app" width="360"></td>
    <td><img src="preview/vuejs-snapshot.png" alt="aardwin login card rendered in a Vue app" width="360"></td>
  </tr>
</table>

## Quickstart

Minimal path — the full guide is in [server-sdk/README.md](server-sdk/README.md).
...
3. Callback route: verify `state`, then call `exchangeCode()` from `@aardwin/auth-server` → user identity → mint your own session. Full checklist: [server-sdk/README.md](server-sdk/README.md).
...
- Browser SDK: [browser-sdk/README.md](./browser-sdk/README.md)
- Full integration guide: [server-sdk/README.md](./server-sdk/README.md)
